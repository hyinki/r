...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Logged in successfully! Redirecting...', { autoClose: 3000 }); // Success Toast
  ...
  return (
    <Container className="mt-5">
      ...
      <Form onSubmit={onSubmit}> {/* React Bootstrap Form */}
        <Form.Group controlId="formEmail"> {/* Bootstrap Form.Group */}
        ...
        <Form.Group controlId="formPassword"> {/* Bootstrap Form.Group */}
        ...
        <Button variant="primary" type="submit" className="mt-3"> {/* Bootstrap Button */}
          Login
        </Button>
      </Form>
    </Container>
